...
outputFolder <- "/home/guelfi/eQTLPipeline/data/results/genic/geneIntronic/resMatrixEQTL/SNIG/"
fullResults <- "/home/guelfi/eQTLPipeline/data/results/genic/geneIntronic/fullResults/SNIG/"
